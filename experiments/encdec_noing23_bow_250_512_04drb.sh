...
##################################################### Model Run Options #############################################
# Dataset options
enc_inputs='../data/rl_no_ing_23.th7'
...
valid_enc_inputs='/homes/iws/kingb12/data/rl_vno_ing_23.th7'
...
test_enc_inputs='/homes/iws/kingb12/data/rl_tno_ing_23.th7'
...
&& cd experiments && bash eval_encdec_noing23_bow_250_512_04drb.sh
