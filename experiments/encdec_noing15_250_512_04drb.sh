...
valid_enc_inputs='/homes/iws/kingb12/data/rl_vno_ing_15.th7'
...
test_enc_inputs='/homes/iws/kingb12/data/rl_tno_ing_15.th7'
...
&& cd experiments && bash eval_encdec_noing15_250_512_04drb.sh
