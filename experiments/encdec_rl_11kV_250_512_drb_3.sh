...
model_name='encdec_rl_11kV_200_512_04drb_3'
# common adjustments
max_epochs=50
...
first_reinforce_epoch=2
##################################################### Model Run Options #############################################
# Dataset options
enc_inputs='../data/rl_enc_inputs_11k.th7'
dec_inputs='../data/rl_dec_inputs_11k.th7'
outputs='../data/rl_outputs_11k.th7'
in_lengths='../data/rl_in_lengths.th7'
out_lengths='../data/rl_out_lengths.th7'
helper='../data/rl_helper_11.th7'

valid_enc_inputs='/homes/iws/kingb12/data/rl_venc_inputs_11k.th7'
valid_dec_inputs='/homes/iws/kingb12/data/rl_vdec_inputs_11k.th7'
valid_outputs='/homes/iws/kingb12/data/rl_voutputs_11k.th7'
valid_in_lengths='/homes/iws/kingb12/data/rl_vin_lengths.th7'
valid_out_lengths='/homes/iws/kingb12/data/rl_vout_lengths.th7'

test_enc_inputs='/homes/iws/kingb12/data/rl_tenc_inputs_11k.th7'
test_dec_inputs='/homes/iws/kingb12/data/rl_tdec_inputs_11k.th7'
test_outputs='/homes/iws/kingb12/data/rl_toutputs_11k.th7'
test_in_lengths='/homes/iws/kingb12/data/rl_tin_lengths.th7'
test_out_lengths='/homes/iws/kingb12/data/rl_tout_lengths.th7'
...
-reinforcement \
-print_reinforcement_reward_every 1 \
-reward_threshold $reward_threshold \
-first_reinforce_epoch $first_reinforce_epoch \
-run  \
-gpu \
-stop_criteria_num_epochs $stop_criteria_num_epochs \
&& cd experiments && bash eval_encdec_11k_250_512_04drb_3.sh
